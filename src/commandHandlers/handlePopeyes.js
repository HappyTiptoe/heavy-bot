...
module.exports = (msg) => {
  ...
  const popeyesLogoURL = 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/34/Popeyes_Logo_With_Symbol_2019.svg/1024px-Popeyes_Logo_With_Symbol_2019.svg.png'

  const embed = {
    color: '#FF7C00',
    title: 'Order up!',
    fields: [
      { name: 'Entree', value: `${entree.name} (${entree.cal}cal)`, inline: true },
